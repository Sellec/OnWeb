                ...
                try
                {
                    ...
                    foreach (var extension in extensions)
                    {
                        ...
                        if (method != null)
                        {
                            ...
                            if (extension.Attributes.IsAdminPart && _controller.ModuleBase.CheckPermission(module.AppCore.Get<UserContextManager<Core.ApplicationCore>>().GetCurrentUserContext(), ModulesConstants.PermissionManage) != CheckPermissionResult.Allowed)
