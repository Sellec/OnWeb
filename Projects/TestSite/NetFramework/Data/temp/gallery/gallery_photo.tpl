...
$(function(){
    ...
    <div class="subpath"><a href="/" title="">Главная</a> &rarr; <a href="/@Module.Name" title="">Фотоархив</a> &rarr; <a href="/@Module.Name/gallery/<{$data.gallery}>" title=""><{$data.gallery_name}></a></div>
    ...
    <div class="prevnext">
     <div class="prev_photo"><{if isset($prev)}><a href="/@Module.Name/photo/<{$prev.id}>" title="">&larr; Предыдущее</a><{/if}></div>
     <div class="next_photo"><{if isset($next)}><a href="/@Module.Name/photo/<{$next.id}>" title="">Следующее &rarr;</a><{/if}></div>
    </div>
