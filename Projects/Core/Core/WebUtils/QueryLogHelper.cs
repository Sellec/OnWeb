...
namespace OnWeb.Core.WebUtils
{
    ...
    public static class QueryLogHelper
    {
        ...
        //{
        //    RepositoryAndQueryExtensions.OnQueryExecuted += (query) =>
        //    {
        //        if (QueryLogEnabled)
        //        {
        //            if (_queries == null) _queries = new List<RepositoryAndQueryExtensions.QueryInfo>();
        //            _queries.Add(query);
        //        }
        //    };
        //}
        ...
        ///// </summary>
        //public static List<RepositoryAndQueryExtensions.QueryInfo> GetQueries()
        //{
        //    if (_queries == null) _queries = new List<RepositoryAndQueryExtensions.QueryInfo>();
        //    return _queries;
        //}
        ...
        //[ThreadStatic]
        //private static List<RepositoryAndQueryExtensions.QueryInfo> _queries;
    }
}
